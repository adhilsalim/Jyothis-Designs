...
design.designs.forEach((item) => {
    html +=
        ...
        <div class="product__item">
            <div class="product__item__pic set-bg" data-mid=${item.d_id}  data-setbg=${item.image} onclick="${item.function}">
            ...
            <div class="product__item__text">
                <h6><a href="${item.link}" data-mid=${item.d_id} onclick="${item.function}">${item.small_text}</a></h6>
...
document.getElementById('design-s-0').innerHTML = html;

html = "";

design.categories.forEach((item) => {
    html +=
        `<div class="card">
